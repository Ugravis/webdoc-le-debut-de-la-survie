            ...
            <div className="flex-col gap-2 messages">
              {currentNode ? (
                ...
                <div className="flex-center">
                  <Link to="/game/mental-health/press-review" className="btn-small-secondary">Next</Link>
                </div>
              )}
            </div>
      ...
      {popupVisible && (
        <div className="popup-overlay" id='popup-intro-choices' onClick={() => setPopupVisible(false)}>
          <div className="popup-content flex-col gap-3" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex-center">
              <button className="btn-small" onClick={() => setPopupVisible(false)}>Discuter sur le groupe</button>
            </div>
          </div>
        </div>
      )}
